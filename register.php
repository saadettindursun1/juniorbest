            ...
            <form method="POST" id="register-form">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="first-name" class="form-control" id="first-name" aria-describedby="first-name-warning" placeholder="Adınızı Giriniz">
                        <small id="first-name-warning" class="form-text text-muted">Adınızı girmediniz</small>
                    </div>

                    <div class="form-group">
                        <label for="last-name">Soyad</label>
                        <input type="text" name="last-name" class="form-control" id="last-name" aria-describedby="last-name-warning" placeholder="Soyadınızı Giriniz">
                        <small id="last-name-warning" class="form-text text-muted">Soyadınızı girmediniz</small>
                    </div>

                    <div class="form-group">
                        <label for="mail">Mail</label>
                        <input type="email" name="mail" class="form-control" id="mail" aria-describedby="mail-warning" placeholder="Mail Adresinizi Giriniz">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" id="password" aria-describedby="password-warning" placeholder="Parolanızı Giriniz">
                ...
                <div class="card-footer bg-white">
                    <input value="Kayıt Ol" name="user-register" id="user-register" readonly>
