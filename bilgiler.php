...
<body>
    ...
    <div class="">
        ...
        <div class="timeline-steps aos-init aos-animate" data-aos="fade-up">
            <div class="timeline-step <?php if ($asama == 1) {
                                            echo "active-step";
                                        } ?>">
            ...
            <div class="timeline-step <?php if ($asama == 2) {
                                            echo "active-step";
                                        } ?>">
            ...
            <div class="timeline-step <?php if ($asama == 3) {
                                            echo "active-step";
                                        } ?>">
            ...
            <div class="timeline-step <?php if ($asama == 4) {
                                            echo "active-step";
                                        } ?>">
            ...
            <div class="timeline-step <?php if ($asama == 5) {
                                            echo "active-step";
                                        } ?>">
                <div class="timeline-content" data-toggle="popover" data-trigger="hover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2010">
                    <div class="inner-circle"></div>
