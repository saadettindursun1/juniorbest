            ...
            <form method="POST" id="register-form">
                ...
                <div class="card-footer bg-white">
                    ...
                    if (isset($_POST['login-btn'])) {
                        ...
                        $select = "user_id,user_first_name,user_last_name,user_mail,user_login_type,user_nickname,user_info,user_deleted";
                        ...
                        if (isset($get_user["user_mail"])) {
                            if ($get_user["user_deleted"] == 1) {
                                ...
                                $_SESSION["user_first_last_name"] = $get_user["user_first_name"] . " " . $get_user["user_last_name"];
                                ...
                                $_SESSION["user_info"] = $get_user["user_info"];
