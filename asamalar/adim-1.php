<form method="POST" id="update-nickname-form">
    <div class="container-fluid mt-5 col-md-6 align-items-center justify-content-center">
        ...
        <div class="card-login text-center">
            ...
            <div class="card-body">
                <input type="text" id="nickname" name="nickname" class="" maxlength="25">
                <br>
                <small id="nickname-warning" class="form-text text-left">Seçeceğiniz nickname özel karakter
                    içermemelidir. </small>
            </div>
            <div>
                <button type="submit" id="create-nickname" name="create-nickname" class="btn btn-dark btn-block ">Kaydet</button>
                <?php
