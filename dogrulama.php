...
<body style="background: linear-gradient(248.22deg,#1E8075 -2.64%,#00473F 93.03%);">
    <form method="POST">
        <div class="row justify-content-center align-items-center" style="margin-top: 200px;">
            <input type="text" name="code-1" class="verify-input input" maxlength="1" required>
            <input type="text" name="code-2" class="verify-input input" maxlength="1" required>
            <input type="text" name="code-3" class="verify-input input" maxlength="1" required>
            <input type="text" name="code-4" class="verify-input input" maxlength="1" required>
            <input type="text" name="code-5" class="verify-input input" maxlength="1" required>
            <input type="text" name="code-6" class="verify-input input" maxlength="1" required>
        </div>


        <div class="row justify-content-center align-items-center" style="margin-top: 30px;">
            <input type="submit" name="button" value="DOĞRULA" class=" btn verify-button">
        </div>
        <div class="col-md-12 text-center verify-content">
            <?php
    ...
    <form method="post">
        <button type="submit" name="re-send-code" class="btn btn-outline-light re-verify-button">Yeniden Kod
            Gönder</button>
    </form>
    </div>
    </div>
